...
skills = [ (_,) for _ in (['Python', 'SQL', 'API', 'Discord','HTML','CSS', 'AI'])]
...
if __name__ == '__main__':
    manager = DB_Manager("projects.db")
    manager.insert_project([(200, "pokemon", "pokemon.com", 3)])
    manager.insert_project([(300, "açık_arttırma", "açıkarttırma.com", 4, "açıkarttırmabotu")])
